...
$.draw = function(turnOn, event$) {
  $.drawingOn = turnOn;
  if (!(event$ == null)) {
    $.x = event$.get$offsetX();
    $.y = event$.get$offsetY();
    $.window().requestAnimationFrame$1(new $.draw_anon());
  }
};
...
$.main = function() {
  $.drawCanvas();
  $.add$1($.query('#clear').get$on().get$click(), new $.main_anon());
};
...
$.drawCanvas = function() {
  $.canvas = $._Elements_CanvasElement($.width, $.height);
  $.add$1($.query('#canvas').get$nodes(), $.canvas);
  $.context = $.canvas.getContext$1('2d');
  $.add$1($.canvas.get$on().get$mouseDown(), new $.drawCanvas_anon());
  $.add$1($.canvas.get$on().get$mouseUp(), new $.drawCanvas_anon0());
  $.add$1($.canvas.get$on().get$mouseMove(), new $.drawCanvas_anon1());
};
...
$.drawPoint = function(time) {
  $.print($.S($.x) + ', ' + $.S($.y));
  $.context.beginPath$0();
  $.context.arc$6($.x, $.y, 15, 0, 6.283185307179586, false);
  $.context.stroke$0();
};
...
$.move = function(event$) {
  ...
  $.y = event$.get$offsetY();
  if ($.drawingOn === true)
    $.window().requestAnimationFrame$1(new $.move_anon());
};
